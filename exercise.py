...
class TestExercise(unittest.TestCase):
    ...
    # Assume date is of following format: MM/DD/YYYY (Example:- 07/02/1994)
    ...
    # Notice that you are using symbolic names instead of numbers like group(1) or group(2)
    # LOOK AT THE DOCUMENTATION OF HOW TO DO THIS.
